...
plt.figure(figsize = (10,3))
plt.plot(mydata.index, mydata['Qtot[m3/s]']*3600, color = 'black')
plt.plot(mydata.index, mydata['Qoutlandsup[m3/s]']*3600, color = 'green')
plt.plot(mydata.index, mydata['Qoutlandsub[m3/s]']*3600, color = 'blue')
plt.plot(mydata.index, mydata['Qoutbottom[m3/s]']*3600, color = 'orange')
plt.xticks(rotation=45)
